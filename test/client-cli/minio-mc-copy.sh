...
EXEC_ECHO mc cp --insecure data-08k.txt s3baby/mybucket1/object2.txt
EXEC_ECHO mc cp --insecure s3baby/mybucket1/object2.txt "zzz1"
EXEC_ECHO cmp "zzz1" data-08k.txt

EXEC_ECHO mc cp --insecure data-04m.txt s3baby/mybucket1/object3.txt
EXEC_ECHO mc cp --insecure s3baby/mybucket1/object3.txt "zzz1"
EXEC_ECHO cmp "zzz1" data-04m.txt

EXEC_ECHO mc cp --insecure data-20m.txt s3baby/mybucket1/object4.txt
EXEC_ECHO mc cp --insecure s3baby/mybucket1/object4.txt "zzz1"
EXEC_ECHO cmp "zzz1" data-20m.txt

EXEC_ECHO mc cp --insecure data-01g.txt s3baby/mybucket1/object5.txt
EXEC_ECHO mc cp --insecure s3baby/mybucket1/object5.txt "zzz1"
EXEC_ECHO cmp "zzz1" data-01g.txt

ECHO "Clean up"

EXEC_ECHO mc rm --insecure s3baby/mybucket1/object1.txt
EXEC_ECHO mc rm --insecure s3baby/mybucket1/object2.txt
EXEC_ECHO mc rm --insecure s3baby/mybucket1/object3.txt
EXEC_ECHO mc rm --insecure s3baby/mybucket1/object4.txt
EXEC_ECHO mc rm --insecure s3baby/mybucket1/object5.txt
