...
## EXEC_ECHO rclone --no-check-certificate -v mkdir s3bbs:${BKT} || true
## EXEC_ECHO rclone --no-check-certificate -v ls s3bbs:${BKT}
...
EXEC_ECHO rclone --no-check-certificate -v delete s3bbs:${BKT}/data/object1.txt
EXEC_ECHO rclone --no-check-certificate -v delete s3bbs:${BKT}/data/object2.txt
EXEC_ECHO rclone --no-check-certificate -v delete s3bbs:${BKT}/data/object3.txt
EXEC_ECHO rclone --no-check-certificate -v delete s3bbs:${BKT}/data/object4.txt
EXEC_ECHO rclone --no-check-certificate -v delete s3bbs:${BKT}/data/object5.txt
...
EXEC_ECHO rclone --no-check-certificate -v copy datafiles s3bbs:${BKT}/data/
...
## EXEC_ECHO rclone --no-check-certificate -v rmdir s3bbs:${BKT}
